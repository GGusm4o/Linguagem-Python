# 🐍 Repositório de Desafios em Python

Este repositório contém uma coleção de **desafios práticos em Python**, organizados por temas fundamentais da linguagem.  
O objetivo é servir como material de estudo e prática para quem deseja reforçar conceitos de programação.

---

## 📂 Estrutura do Repositório

Os desafios estão divididos em pastas por assunto:
